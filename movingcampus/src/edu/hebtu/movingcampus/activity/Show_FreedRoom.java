...
public class Show_FreedRoom extends BaseAsyncTaskActivity {
	...
	private void InitList() {
		...
		ArrayList<String> list_weekday = new ArrayList<String>();
		ArrayList<String> list_school = new ArrayList<String>();
		ArrayList<String> list_building = new ArrayList<String>();
		ArrayList<String> list_weeks = new ArrayList<String>();
	...
	private void InitSpinnerList() {
		...
		this.adapter_School.setDropDownViewResource(R.layout.item);
		this.spinner_school
		...
		this.adapter_building = new ArrayAdapter<String>(
				getApplicationContext(), R.layout.item, buildings);

		this.spinner_building.setAdapter(adapter_building);
		this.adapter_building.setDropDownViewResource(R.layout.item);
		...
		this.adapter_unit.setDropDownViewResource(R.layout.item);
		this.spinner_unit
				.setOnItemSelectedListener(new OnItemSelectedListener() {
		...
		this.adapter_weekday = new ArrayAdapter<String>(
				getApplicationContext(), R.layout.item, weekdays);

		this.spinner_weekday.setAdapter(adapter_weekday);
		this.adapter_weekday.setDropDownViewResource(R.layout.item);
		...
		this.adapter_weeks.setDropDownViewResource(R.layout.item);
		this.spinner_weeks
				.setOnItemSelectedListener(new OnItemSelectedListener() {
	...
	private void getMessage() {
		ArrayList<ClassRoom> res = (ArrayList<ClassRoom>) new RoomDao(
				Show_FreedRoom.this).getFreeRoomMsg(false, school, building,
				week, weekday, unit);
	...
	private class MyAdapter extends BaseAdapter {
		...
		public View getView(int paramInt, View paramView,
			...
			paramView = LayoutInflater.from(getApplicationContext()).inflate(
					R.layout.freeroom_item, null);
			TextView mycollege = (TextView) paramView
					.findViewById(R.id.freeroom_college);
			TextView mybuilding = (TextView) paramView
					.findViewById(R.id.freeroom_building);
			TextView myweek = (TextView) paramView
					.findViewById(R.id.freeroom_week);
			TextView myweekday = (TextView) paramView
					.findViewById(R.id.freeroom_weekday);
			TextView myclass = (TextView) paramView
					.findViewById(R.id.freeroom_class);
			TextView myroom = (TextView) paramView
					.findViewById(R.id.freeroom_room);
