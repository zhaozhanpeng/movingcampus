...
public class CourseIntroEntity {
	...
	/**
	 * @param suiltabelPeople
	 *            the suiltabelPeople to set
	 */
	...
	/**
	 * @param courseBelongTo
	 *            the courseBelongTo to set
	 */
