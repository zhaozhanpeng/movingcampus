...
public class ChooseCourseEntity {
	...
	/**
	 * @param roomOfCourse the roomOfCourse to set
	 */
	...
	/**
	 * @param methosOfTeach the methosOfTeach to set
	 */
	...
	/**
	 * @param nativeChoosedNum the nativeChoosedNum to set
	 */
	...
	/**
	 * @param allChoosedNum the allChoosedNum to set
	 */
