...
public class NewsListActivity extends BaseActivity implements OnClickListener,
	...
	private void initControl() {
		...
		// R.layout.news_item_layout,listview);
		...
		protected void onPreExecute() {
			...
			if (typeID.equals("0"))
				IPreference.getInstance(NewsListActivity.this)
						.getListOfNewsSubjectByID(Integer.parseInt(typeID))
						.clear();
	...
	// ((TextView)
	// mUpdateView.getTag(R.id.new_item_title_view)).setTextColor(0xff9C9C9C);
	// mUpdateView = null;
	// mNewsItem = null;
	// }
	// }
