...
public class ExamInforAdapter extends AdapterBase<ExamineInfor> {
	...
	protected View getNextView(int position, View convertView, ViewGroup parent) {
		convertView = LayoutInflater.from(parent.getContext()).inflate(
				R.layout.exanination_show_list_item, null);
		TextView examName = (TextView) convertView
				.findViewById(R.id.examlist_item_kcm);
		TextView examDate = (TextView) convertView
				.findViewById(R.id.examlist_item_ksrq);
		TextView examTime = (TextView) convertView
				.findViewById(R.id.examlist_item_kssj);
		TextView examPlace = (TextView) convertView
				.findViewById(R.id.examlist_item_roomid);
